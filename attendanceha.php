...
<body>
    <h2>Students Marked for Hackathon Present Today</h2>
    <?php
    ...
    $attendance_query = "SELECT DISTINCT registerHack.name, registerHack.srn 
                        FROM registerHack
                        INNER JOIN attendanceH 
                        ON registerHack.srn = attendanceH.srn
                        WHERE attendanceH.date = '$current_date'";
